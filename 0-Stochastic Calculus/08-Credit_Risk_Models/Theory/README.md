...
**Structural models (Merton, Black–Cox):**  default arises from the firm's balance sheet and asset dynamics.

**Reduced-form / intensity models (hazard rates):**  default is a surprise event governed by a stochastic intensity calibrated directly to CDS curves.

**Copula models for multi-name credit:**  provide a dependence structure between several default times, essential for baskets, CDO tranches, and index products.
